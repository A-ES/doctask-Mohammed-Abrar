...
- [ ] 1. Define State schema, configuration, and core types
  - [ ] 1.1 Create the PipelineState TypedDict and supporting types
  ...
  - [ ] 1.2 Create JSONB serialization/deserialization utilities
  ...
  - [ ] 1.3 Write property test for State JSONB round-trip
  ...
  - [ ] 1.4 Create PipelineConfig loader with defaults
...
- [ ] 2. Implement routing functions
  - [ ] 2.1 Create the routing function factory and per-node routing logic
  ...
  - [ ] 2.2 Write property test for routing determinism
  ...
  - [ ] 2.3 Write property test for retry routing correctness
  ...
  - [ ] 2.4 Write property test for unrecognized error type escalation
  ...
  - [ ] 2.5 Write property test for skip routing and metadata
...
- [ ] 3. Checkpoint - Ensure state schema and routing tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Implement Understand Stage nodes
  - [ ] 4.1 Implement the `ingest` node
  ...
  - [ ] 4.2 Implement the `extract_text` node
  ...
  - [ ] 4.4 Write property test for chunk coverage
...
- [ ] 5. Implement Examine Stage nodes
  - [ ] 5.1 Implement the `extract_claims` node
  ...
  - [ ] 5.2 Write property test for extraction offset ordering
  ...
  - [ ] 5.3 Implement the `match_rules` node
  ...
  - [ ] 5.4 Write property test for verdicts-claims length parity
  ...
  - [ ] 5.5 Implement the `score_confidence` node
  ...
  - [ ] 5.6 Write property test for confidence flagging threshold
...
- [ ] 6. Checkpoint - Ensure Understand and Examine stage tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Implement Stay-Alive Stage nodes
  - [ ] 7.1 Implement the `route_to_queue` node
  ...
  - [ ] 7.2 Write property test for claim partitioning priority
  ...
  - [ ] 7.3 Write property test for escalate bucket routing
  ...
  - [ ] 7.4 Implement the `human_review` interrupt node
  ...
  - [ ] 7.5 Write property test for post-human-review routing
  ...
  - [ ] 7.6 Implement the `finalize` node
...
- [ ] 8. Implement checkpoint and resume infrastructure
  - [ ] 8.1 Create the checkpoint persistence layer
  ...
  - [ ] 8.2 Write property test for checkpoint-if-and-only-if-success
  ...
  - [ ] 8.4 Write property test for resume restart correctness
...
- [ ] 9. Assemble the StateGraph and wire all components
  - [ ] 9.1 Build the LangGraph StateGraph with all nodes and conditional edges
  ...
  - [ ] 9.2 Write property test for stage ordering invariant
  ...
  - [ ] 9.3 Write property test for node completion contract
  ...
  - [ ] 9.4 Create the run initialization endpoint
  ...
  - [ ] 9.5 Wire the human review polling service
