...
export const mockQueueItems: QueueItem[] = [
  {
    ...
    item_type: "finding",
    payload: {
      summary: "Potential non-compliance with Section 4.2 capital adequacy requirements",
  ...
  },
  {
    ...
    item_type: "conflict",
    payload: {
      summary: "Conflicting statements regarding loan-to-value ratios in sections 3.1 and 5.4",
  ...
  },
  {
    ...
    payload: {
      summary: "Update interest rate disclosure language to match revised regulatory guidance",
  ...
  },
  {
    ...
    payload: {
      ...
      source_citations: [
        ...
        {
          claim_id: "claim-006",
          claim_text: "Customers must be notified 30 days prior to fee changes",
          citation_status: "grounded",
          source_location: {
            page_number: 5,
            section_id: "sec-7.3",
  ...
  },
  {
    ...
    item_type: "conflict",
    payload: {
      summary: "Data retention policy conflicts between privacy section and appendix B",
    ...
    justification: "Conflict does not exist — appendix B references archived policy.",
  },
  {
    id: "item-006",
    run_id: "run-001",
    ...
    payload: {
      ...
      source_citations: [
        {
          claim_id: "claim-008",
          claim_text: "Executive summaries must include material risk factors",
          citation_status: "unverifiable",
          source_location: null,
        },
      ],
...
export const mockQueueResponse: QueueListResponse = {
  run_id: "run-001",
...
export const mockProgressRunning: PipelineProgress = {
...
export const mockProgressCompleted: PipelineProgress = {
  current_node: null,
  completed_nodes: [
    "ingest",
    "extract_text",
...
export const mockProgressPaused: PipelineProgress = {
